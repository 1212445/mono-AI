...
<template>
  <SidebarProvider>
    <AppSidebar />
    <SidebarInset>
      <header class="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 select-none">
      ...
      <div class="flex min-h-screen flex-col items-center justify-center p-6 md:p-12 lg:p-16 select-none">
        <div class="w-full max-w-5xl space-y-10">
          <div class="text-center space-y-5">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground select-none">
              欢迎使用
              <span class="block mt-2">Mono 你的专属个人知识管家</span>
            </h1>
            <p class="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto opacity-80 leading-relaxed select-none">
              人工智能的精准与高端设计的灵魂相遇。
              今天我们可以为您策划什么想法？
            </p>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 select-none">
            <div
            ...
            >
              ...
              <div class="relative space-y-3">
                <div class="flex items-center gap-2.5">
                  ...
                  <span class="text-base font-medium text-foreground">{{ card.category }}</span>
                </div>
